...
/**
 * This is an appointment booked Email.
 */
?>
<div class="row">
    <div class="content-wrapper text_block">
        <div class="" style="padding: 5px;font-family: Arial, sans-serif;font-size: 16px">
            ...
            <p style="text-align: left">Thank you for booking an appointment.</p>
            <p>Your appointment will be from <strong>{appointment_start_time}</strong> to <strong>{appointment_end_time}.</strong></p>
        </div>
    </div>
</div>
