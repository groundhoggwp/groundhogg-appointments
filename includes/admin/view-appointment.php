...
<table class="form-table">
    <tbody>
        <tr class="form-field term-name-wrap">
            ...
            <td><?php _e( $appointment->name , 'groundhogg' ); ?></td>
        </tr>
        ...
        <tr class="form-field term-calendar-description-wrap">
            ...
            <td><?php _e(  date('Y-m-d H:i:s', $appointment->start_time ), 'groundhogg' ) ;  ?></td>
        </tr>
        <tr class="form-field term-calendar-description-wrap">
            <th scope="row"><label for="user_id"><?php _e( 'Appointment End Time' ,'groundhogg') ?></label></th>
            <td><?php _e(date('Y-m-d H:i:s', $appointment->end_time ) , 'groundhogg' ); ?></td>
        </tr>
        <tr class="form-field term-calendar-description-wrap">
            <th scope="row"><label for="user_id"><?php _e( 'Notes' ,'groundhogg') ?></label></th>
            <td><?php  _e( WPGH_APPOINTMENTS()->appointmentmeta->get_meta($appointment_id,'note',true) , 'groundhogg' );?></td>
        </tr>
        <tr>
            <td colspan="2">
