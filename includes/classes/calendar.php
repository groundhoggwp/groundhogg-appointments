...
//	}
	 ...
	 * @return array
	 */
	public function get_google_appointment1( $min_time, $max_time ) {
		$access_token       = $this->get_access_token();
		$google_calendar_id = $this->get_google_calendar_id();
		if ( $access_token && $google_calendar_id ) {
			...
			$google_cal = '7kfjnepngcqef8n8u0nu9e18lk@group.calendar.google.com';
...
//								) );
			...
			echo $this->get_google_appointment( $min_time, $max_time );
			var_dump( $google_appointments );
			wp_die();
		}
