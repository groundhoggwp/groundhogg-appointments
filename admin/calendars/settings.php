...
<form name="" id="" method="post" action="">
    ...
    <div style="max-width: 700px">
        <?php wp_editor($calendar->get_meta('message') ? $calendar->get_meta('message') : __('Appointment booked Successfully!', 'groundhogg-calendar'), 'message', ['editor_height' => 200, 'editor_width' => 500]); ?>
    </div>
